        ...
        '<div class="win-box">',
            ...
            '<div class="win-form">',
                '<ul>',
                    ...
                    //'<li><label><span>存储类型：</span></label><label><input name="1" type="radio" value="">&nbsp;本地存储</label>&nbsp;&nbsp;&nbsp;&nbsp;<label><input name="1" type="radio" value="">&nbsp;共享存储</label></li>',
                    //'<li><label><span>路径：</span><input class="txt" type="text" size="40" value=""></label></li>',
                    '<li><label><span>存储类型：</span></label><label><input name="1" type="radio" value="">&nbsp;本地存储</label>&nbsp;&nbsp;&nbsp;&nbsp;<label><input name="1" type="radio" value="">&nbsp;共享存储</label></li>',
                    '<li><label><span>路径：</span><dl class="f-select"><dt class="f-select-hd"><a href="javascript:;">1</a><i class="f-select-arrow icon-arrow-d1"></i></dt><dd class="f-select-bd"><ul><li>1</li><li>2</li></ul></dd></dl></label></li>',
                '</ul>',
            '</div>',
